...
require('./cc_asignacion_revisores_menor_db.php');
...
<br>
<h2  align="center" style="color:black; "  >ASIGNACION DE LOTERIA MENOR PARA REVISION</h2> 
...
<div class="card-body">
  ...
  <table  class="table table-bordered">
    <tr>
      ...
      <th width="15%">Serie Inicial</th>
      <th width="15%">Serie Final</th>
...
<input type="hidden" id="filas_guardadas" name="filas_guardadas" value="<?php echo $j;?>">
