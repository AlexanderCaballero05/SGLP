...
if (mysqli_query($conn,"INSERT INTO cc_revisores_sorteos_menores (id_sorteo,id_revisor,numero,serie_inicial,serie_final) VALUES ('$id_sorteo','$id_revisor','$numero','$billete_inicial','$billete_final') ") === false) {
...
if ($bandera == 1 ) {
if (mysqli_query($conn,"UPDATE sorteos_menores SET control_calidad = 'SI' WHERE id =  '$id_sorteo' ") === TRUE) {
?>
