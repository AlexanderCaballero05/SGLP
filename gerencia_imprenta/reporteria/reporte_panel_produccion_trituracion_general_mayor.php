...
<br>
<h5  align="center" style="color:black; "  >PATRONATO NACIONAL DE LA INFANCIA <br>REPORTE DE BILLETES TRITURADOS EN REPOSICION POR SORTEO LOTERIA MAYOR </h5>
<br>
...
if (isset($_POST['seleccionar'])) {
    ...
    $c_data_sorteos = mysqli_query($conn, "SELECT a.id, a.fecha_sorteo, count(b.id_sorteo) as cantidad FROM sorteos_mayores as a INNER JOIN cc_revisores_sorteos_mayores_control as b ON a.id = b.id_sorteo WHERE a.id BETWEEN '$sorteo1' AND '$sorteo2' AND b.numero_revision = 2 GROUP BY a.id ");
