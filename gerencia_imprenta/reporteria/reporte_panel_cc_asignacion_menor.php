...
$fecha_vencimiento = $i_sorteo->vencimiento_sorteo;
...
$revisores_asignados = mysqli_query($conn, "SELECT a.numero,a.serie_inicial,a.serie_final,b.nombre_completo  FROM cc_revisores_sorteos_menores as a INNER JOIN pani_usuarios as b ON a.id_revisor = b.id WHERE a.id_sorteo = '$id_sorteo'  ");



echo ' Los abajo firmantes recibimos el dia '.$fecha_actual.' lo siguiente: <br><br>
<b>SORTEO DE LOTERIA MENOR '.$numero_sorteo.'</b> a realizarse el dia '.$fecha_sorteo.', con fecha de caducidad '.$fecha_vencimiento;
...
<input type="hidden" name="id_sorteo_oculto"  value="<?php echo $id_sorteo;?>"></input>
  ...
  <table id="print" width="100%" class="table table-bordered"  id="detalle_revisor">
    <tr>
      ...
      <th width="12.5%">Desde Serie</th>      
      <th width="12.5%">Hasta Serie</th>
