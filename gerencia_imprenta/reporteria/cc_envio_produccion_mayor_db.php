...
if (mysqli_query($conn,"UPDATE cc_produccion_mayor  SET estado_envio_produccion = 'ENVIADO', fecha_envio_produccion = '$fecha_actual' WHERE id = '$id' ") === TRUE ) {
...
if (mysqli_query($conn,"UPDATE cc_produccion_mayor  SET estado_recepcion_cc = 'RECIBIDO', fecha_recepcion_cc = '$fecha_actual' WHERE id = '$id' ") === TRUE ) {

echo "<div class = 'alert alert-success'>Recepcion de loteria en reposicion realizada correctamente. </div>";
...
$info_finalizacion = mysqli_query($conn, "SELECT * FROM cc_produccion_mayor WHERE id = '$id' ");
...
$delete_finalizacion =  mysqli_query($conn, "DELETE FROM cc_produccion_mayor WHERE id_sorteo = '$id_sorteo' AND id_revisor = '$id_revisor' AND numero_revision >= '$numero_revision' ");


$update  =  mysqli_query($conn, "UPDATE cc_revisores_sorteos_mayores_control SET estado = 'PENDIENTE' WHERE id_sorteo = '$id_sorteo' AND id_revisor = '$id_revisor' AND num_lista = '$num_lista' AND  numero_revision = '$numero_revision' AND estado = 'APROBADO' ");


$update  =  mysqli_query($conn, "UPDATE cc_revisores_sorteos_mayores_control SET estado = 'PENDIENTE' WHERE id_sorteo = '$id_sorteo' AND id_revisor = '$id_revisor' AND num_lista = '$num_lista' AND numero_revision > '$numero_revision'  ");


$numero_revision ++;

$delete_posteriores = mysqli_query($conn, "DELETE FROM cc_revisores_sorteos_mayores_control WHERE id_sorteo = '$id_sorteo' AND id_revisor = '$id_revisor' AND numero_revision > '$numero_revision' AND num_lista = '$num_lista'  ");
