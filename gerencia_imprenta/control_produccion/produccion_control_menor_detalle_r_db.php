...
if (isset($id_control)) {
	...
	$c_listas = mysqli_query($conn, "SELECT numero FROM cc_revisores_sorteos_menores WHERE id_sorteo = '$id_sorteo' ");
...
if (isset($_POST['guardar_detalle'])) {
	...
	if (mysqli_query($conn, "INSERT INTO pro_control_detalle_menor (id_control ,lista , cantidad ,tipo ,numeradora_parcial, observaciones) VALUES ('$id_control','$lista','$cantidad','$tipo' ,'$numeradora_parcial','$observaciones') ") === false) {
		echo mysqli_error();
	} else {
