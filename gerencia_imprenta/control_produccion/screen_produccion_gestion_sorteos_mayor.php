...
if (isset($_POST['cambiar_estado'])) {
	...
	if (mysqli_query($conn, " UPDATE sorteos_mayores SET produccion = '$new_estado' WHERE id = '$id_sorteo' ") === TRUE) {
...
<ul class="nav nav-tabs" style="margin-left: 10px; margin-right: 10px">
  ...
  <li class="nav-item">
    <a class="nav-link" href="./screen_produccion_gestion_sorteos_menor.php" >Lotería Menor</a>
  </li>
</ul>

<section style="background-color:#ededed;">
<br>
<h2  align="center" style="color:black; "  >GESTION DE ETAPAS DE PRODUCCION MAYOR</h2>
<br>
</section>
