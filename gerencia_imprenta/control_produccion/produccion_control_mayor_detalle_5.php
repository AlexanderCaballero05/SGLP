...
require './produccion_control_mayor_detalle_5_db.php';
?>
...
<div class="input-group" style="margin-top: 5px">
	...
	<select class="form-control" style="" id="tipo" name="tipo" >
...
if ($etapa == 5) {
	echo "Etapa No. 2 para reposicion";
} else {
	echo "Etapa No. " . $etapa;
}
...
<input style="width:50%;text-align:  center" min="<?php echo $billete_inicial_control; ?>" max="<?php echo $billete_final_grupo; ?>" onblur="calculo_buenos(this.value)" onkeypress="return isNumberKey(event)" class="form-control" type="number"  id="billete_final" name="billete_final" value="<?php echo $billete_final_control; ?>"  readonly = 'true' >
</div>
