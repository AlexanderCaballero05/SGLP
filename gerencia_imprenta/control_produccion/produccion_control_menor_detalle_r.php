...
require './produccion_control_menor_detalle_r_db.php';
?>
...
cantidad_total =   parseInt(cantidad_i);
...
<br>
<h2  align="center" style="color:black; "  >Control de Produccion de Reposiciones de Loteria Nacional Menor</h2>
<br>
</section>
...
<div class="input-group" style="margin-top: 5px">
	<div class="input-group-prepend">
	<span style="width: 100px" class="input-group-text">Lista: </span>
	</div>
...
while ($reg_lista = mysqli_fetch_array($c_listas)) {
	echo "<option value = '" . $reg_lista['numero'] . "'>" . $reg_lista['numero'] . "</option>";
}
...
while ($reg_anterior = mysqli_fetch_array($registros_anteriores)) {
	...
	if ($reg_anterior['tipo'] == 'B. Malos') {
		echo "<option value='B. Buenos'>B. Buenos</option>";
	...
	} elseif ($reg_anterior['tipo'] == 'B. Buenos') {

		$total_buenos += $reg_anterior['cantidad'];

		echo "<option value='B. Buenos' selected>B. Buenos</option>";
		echo "<option value='B. Malos' >B. Malos</option>";
		echo "<option value='H. Blancas' >H. Blancas</option>";
		echo "<option value='P. Montaje' >P. Montaje</option>";
	}
...
<input class = 'form-control'  type="text" id="contador_final" name="contador_final" value="<?php echo $contador_parcial; ?>" class="" readonly>
</div>
...
<input style="text-align: center" class="form-control" type="text" onblur ="f_contador_final(this.value)" id = 'billetes_buenos' name="billetes_buenos" value="<?php echo $total_buenos; ?>" readonly >
</div>
