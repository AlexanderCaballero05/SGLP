...
echo "<h3 align = 'center'>INFORME DE COMISIONES DE LOTERIA <br> <b> DEL ".$fecha_inicial." AL ".$fecha_final."</b></h3>";
...
echo "<tr>";
echo "<td>COMISION BANCARIA</td><td>".number_format($total_comision_mayor,2)."</td>";
echo "<td>".number_format($total_comision_menor,2)."</td>";
$total_concepto = $total_comision_mayor + $total_comision_menor; 
...
echo "<tr>
<td>COMISION VENDEDORES</td><td>".number_format($total_descuento_mayor,2)."</td>";
echo "<td>".number_format($total_descuento_menor,2)."</td>";
$total_concepto = $total_descuento_mayor + $total_descuento_menor; 
echo "<td>".number_format($total_concepto,2)."</td>";
echo "</tr>";
...
echo "<tr>
<td>APORTACION</td><td>".number_format(0,2)."</td>";
echo "<td>".number_format($total_aportacion_menor,2)."</td>";
$total_concepto =  $total_aportacion_menor; 
echo "<td>".number_format($total_concepto,2)."</td>";
echo "</tr>";

$tf_total += $total_concepto;
$tf_mayor = $total_comision_mayor + $total_descuento_mayor;
$tf_menor = $total_comision_menor + $total_descuento_menor + $total_aportacion_menor;

echo "<tr><th >TOTALES</th><th >".number_format($tf_mayor,2)."</th><th>".number_format($tf_menor,2)."</th><th>".number_format($tf_total,2)."</th></tr>";
echo "</table>";
