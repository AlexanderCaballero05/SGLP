...
<section style="text-align: center; background-color:#ededed; padding-top:3px; padding-bottom:-2%;">
  <h4>ASIGNACION | CAMBIO DE CATEGORIA DE EMPLEADOS </h4> <br></section>
<section id="no_print">
    <a style = "width:100%;" id="non-printable"  class="btn btn-secondary" role="button" data-toggle="collapse2" href="" aria-expanded="false" aria-controls="collapse"> AGREGAR | ACTUALIZAR CATEGORIA EMPLEADO <i class="far fa-hand-point-down fa-lg"></i></a>
                ...
                <div class="card-body"  align="center">
                  ...
                  <div class="row" style="margin-top:2%;">
                       ...
                       <div class="col-sm-6" align="center">                                 
                                  <button class="btn btn-success btn-lg" type="submit" name='addfam' id="addfam" > Asignar Categoria</button>
                                  <button class="btn btn-primary btn-lg" type="submit" name='updfam' id="updfam" style="display:none;"> Actualizar Categorias</button>
                      </div>
                      <div class="col-sm-3"></div>
                  </div>                         
              </div>
                  ...
                  <div class="table-responsive">
                    <table id="table_id2" class="table table-bordered table-sm table-hover"   cellspacing="0" style="width:100%;   font-size:13px;">
                       <thead><tr><th></th>   
                                  ...
                                  <th>Categoria</th></tr></thead><tbody>
                            <?php 
                            ...
                            $query_familiares= mysqli_query($conn, "SELECT identidad , cod_empleado, nombre_completo, fecha_ingreso  FROM rr_hh_empleados WHERE status_empleado=1 ORDER BY nombre_completo ASC;");
                              ...
                              if (mysqli_num_rows($query_familiares)>0)
                              {
                                  ...
                                  while ($_row_familiares= mysqli_fetch_array($query_familiares)) 
                                  {
                                    ...
                                    $query_cons_area_labora ="SELECT  a.categoriaid, b.descripcion  FROM organizacional_usuarios_categorias a, organizacional_categorias b WHERE a.categoriaid=b.id and a.usuarioid ='$_cons_identidad_persona' and a.status=1  order by a.fecha_creacion desc limit 1  ;";
                                  //  echo $query_cons_area_labora;
                                    ...
                                    if (mysqli_num_rows($query_area_labora)>0 ) 
                                    {
                                      while ( $row_area_labora = mysqli_fetch_array($query_area_labora )) {
                                          $area_labora     =  $row_area_labora['categoriaid'];
...
<?php 
 ...
 {  
    ...
    {        
        ...
        $query_txt_insert_new="INSERT INTO organizacional_usuarios_categorias(usuarioid, categoriaid ) VALUES('$_ins_identidad_persona', '$_ins_area_trabajo');";
