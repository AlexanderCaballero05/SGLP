      ...
      <div class="collapse2" id="collapse1" align="center">
        <div class="card">
          ...
          <div class="card-header bg-secondary text-white">
            <h4>GESTION DE CATEGORIA DE EMPLEADOS </h4>
          </div>
          ...
          <div class="card-footer">
            <button class="btn btn-primary btn-lg" type="submit" name='updfam' id="updfam" style="display:none;"> Actualizar Categoria</button>
          </div>
        </div>
    </section>
    <hr>
