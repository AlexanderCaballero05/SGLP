...
<section style="text-align: center; background-color:#ededed; padding-top: 10px;">
  <p><h3>ALTA DE EMPLEADOS DEL PANI </h3> </p><br></section>
    ...
    <div class="container-fluid" style="width: 80%">
        ...
        <?php else: ?>
         ...
         <?php endif ?>
                ...
                <div class="group input-group" style="margin-top:10%;">      
                                    <input type="text" id="txtrtn" name="txtrtn" style="width: 95%" onkeypress="return soloLetras(event)" required="true" maxlength="14" >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>RTN </label>
                </div>
                ...
                <div class="group input-group" style="margin-top:10%; width:95%">      
                                   <select class="form-control" name='txtsexo' id='txtsexo' required="true">
               ...
               ?>      
                ...
                <div class="group input-group" style="margin-top:10%;">      
                 ...
                 <?php else: ?>
                      ...
                      <div class="group input-group" style="margin-top:10%;">      
                                    <input type="date" id="fechanacimiento" name="fechanacimiento" style="width:95%" required="true" readonly="true" >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Fecha de Nacimiento </label>
                      </div>
                  ...
                  <?php endif ?>
                <div class="group input-group" style="margin-top:10%; width:95%"> 
                                   <select class="form-control" name='lugarnacimiento' id='lugarnacimiento' style="" required="true">
                                      <option value=''> Seleccione ....</option>
                                     <?php 
                                         ...
                                         while ($row_muni=mysqli_fetch_array($query_lugar_nac)) {
                                           ...
                                           echo "<option value='".$codigo_muni."'> ".$codigo_muni." --  ".$municipio."</option>";
                                         }
                                      ?>
                                   </select>
                                    <span class="highlight"></span>
                ...
                <div class="group input-group" style="margin-top:10%; width:95%">      
                                   <select class="form-control" name='txtsangre' id="txtsangre" required="true">
                                          <option value='' > Seleccione ....</option>
                 ...
                 <div class="group input-group" style="margin-top:10%; width:95%">      
                                    <textarea type='form-control' rows="5" id='domicilio' name='domicilio' style="width: 100%" onkeypress="return soloLetras(event)" onkeyup='this.value=this.value.toUpperCase()' required="true"></textarea>
          ...
          <div class="col-sm-6"><br>
              ...
              <div class="group input-group" style="margin-top:10%;">      
                                    <input type="text" id="txttelefono" name="txttelefono" style="width: 95%" onkeypress="return soloLetras(event)" onkeyup='this.value=this.value.toUpperCase()' required="true" >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
               ...
               <div class="group input-group" style="margin-top:10%;">      
                                    <input type="text" id="txtcelular" name="txtcelular" style="width: 95%" onkeypress="return soloLetras(event)" onkeyup='this.value=this.value.toUpperCase()' required="true" >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
            ...
            <div class="group input-group" style="margin-top:10%; width:95%">      
                                   <input type="date" name="fecha_ingreso" required="true">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
            ...
            <div class="group input-group" style="margin-top:10%;">      
                                    <input type="number" id="txtcodempleado" name="txtcodempleado" style="width: 95%" onkeypress="return justNumbers(event)" required="true" >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
            ...
            <div class="group input-group" style="margin-top:10%;">      
                                    <input type="number" id="txtcodmarcacion" name="txtcodmarcacion" style="width: 95%" onkeypress="return justNumbers(event)" required="true" >
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
 ...
 {  
  ...
  //   $_fecha_nacimiento   = $_POST['fechanacimiento'];
    ...
    $query_insert_empleado= "INSERT INTO rr_hh_empleados(cod_empleado,     cod_marcacion,      identidad,    rtn,      sexo,      fecha_nacimiento,      lugar_nacimiento,       tipo_sangre,     nombre_completo,      primer_nombre,   segundo_nombre,        primer_apellido,       segundo_apellido,      fecha_ingreso,      domicilio,      telefono,     celular ,  estado_civil,       escolaridad) 
                                                  VALUES ($_cod_empleados, $_codmarcacion,  '$_identidad', '$_rtn' , '$_sexo' , '$tfecha' , '$_lugar_nacimiento' , '$_tipo_sangre',  '$_nombre_completo', '$_primer_nombre' , '$_segundo_nombre' , '$_primer_apellido' ,  '$_segundo_apellido',  '$_fecha_ingreso', '$_domicilio' , '$_telefono', '$_celular' , '$_estado_civil', '$_escolaridad');";
