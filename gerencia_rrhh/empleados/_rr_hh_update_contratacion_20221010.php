                ...
                <div class="card-body">
                    ...
                    ?>
                        ...
                        <div class="input-group" style="margin-top: 5px;">
                            ...
                            <input type="text" readonly value='<?php echo number_format( $salario_base_actual ,2); ?>' class="form-control" id="fecha_inicio_actual" name="fecha_inicio_actual" required />
                        </div>
