    ...
    <div class="collapse2" id="collapse1" align="center">
               <div class="card">                      
                ...
                <div class="row" style="padding-top: 8px;">  
                                <div class="col-sm-2">
                                       <div  class="group input-group" style="margin-top:9%;">                    
                                ...
                                <div class="col-sm-3">                        
                                     <div class="group input-group" style="margin-top:6%; width:95%">      
                                        <select class="form-control areatrabaja" name='areatrabaja' id="areatrabaja" required="true" style="margin-top:1%;">
                                        ...
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Gerencia en que labora </label>
                                    </div>
                                </div>  
                                 <div class="col-sm-3">                        
                                     <div class="group input-group" style="margin-top:6%; width:100%">      
                                        <select class="form-control" name='departamentotrabaja' id="departamentotrabaja" required="true" style="margin-top:1%;">                                        
                                        <option value='0'> No asignado, seleccione ....</option>
                                        <?php 
                                        ...
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Departamento en que labora </label>
                                    </div>
                                </div>                              
                  </div>  
                    ...
                    <table id="table_id2" class="table table-bordered table-sm table-hover"   cellspacing="0" style="width:100%;   font-size:13px;">
                       <thead><tr><th></th>   
                            ...
                            $query_familiares= mysqli_query($conn, "SELECT identidad , cod_empleado, nombre_completo, fecha_ingreso  FROM rr_hh_empleados WHERE status_empleado=1 ORDER BY nombre_completo ASC;");
                              ...
                              {
                                  $cont=1; $fila=0; $area_labora=0; $areal_labora_txt ='';   $unidad_labora = 0; $unidad_labora_txt  ='';
