                ...
                if (mysqli_num_rows($query_validacion_empleado_pani)>0) 
                {
                    ...
                    if (mysqli_num_rows($query_area)>0) {  
                     ...
                     echo '<div class="card" >
                             ...
                             // echo  "SELECT identidad_familiar,  nombre_completo, fecha_nacimiento, sexo,   b.descripcion parentesco_txt,  celular, ocupacion,  domicilio, lugar_ocupacion  FROM rr_hh_empleados_familias a, rr_hh_parentescos b WHERE a.parentesco=b.id and a.identidad_empleado='$identidad' ;";       
                       ...
                       if (mysqli_num_rows($query_familiares)>0) 
                       {
                        ...
                        echo '  <div class="table-responsive">   
                         ...
                         while ($row_familiares = mysqli_fetch_array($query_familiares)) 
                         {
                              ...
                              $fecha_calculo_edad = new Datetime($_fecha_nacimiento);
                              $hoy =  new Datetime();
 				     ...
 				     <a href="_rr_hh_update_empleado.php?id='.$identidad_existe.'" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" target="blank" >Información General</a>
                                     <a href="_rr_hh_add_empleado_familia.php?id='.$identidad_existe.'" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" target="blank" >Ficha Familiar</a>
                                     <!-- a href="_rr_hh_update_empleado.php?id='.$identidad_existe.'" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" target="blank" >Información General</a -->                             
                                     <a href="_rr_hh_update_contratacion.php?id='.$identidad_existe.'" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" target="blank" >Contratación y Salario</a>                             
                                     <a href="_rr_hh_update_otros_datos.php?id='.$identidad_existe.'" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" target="blank" >Otros Datos</a>   
                                     <a href="_rr_hh_add_responsable_fallecimiento.php?id='.$identidad_existe.'" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" target="blank" >Responsable en caso de Fallecimiento</a>                            
                                </p>                         
                          </div>
                      </div>';
              }
