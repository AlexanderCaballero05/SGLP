...
<section style="text-align: center; background-color:#ededed; padding-top:3px; padding-bottom:-2%;">
  <h4>CAMBIO DE AREA DE EMPLEADOS </h4> <br></section>
<section id="no_print">
                  ...
                  <div class="row" style="padding-top: 8px; " >  
                                ...
                                <div class="col-sm-3">                        
                                     <div class="group input-group" style="margin-top:6%; width:95%">      
                                        ...
                                        <?php 
                                          $query_parent=mysqli_query($conn, 'SELECT id, descripcion FROM organizacional_gerencias ORDER BY id ASC;');
                                        ...
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Área en que labora </label>
                                    </div>
                                </div>                               
                  </div>  
                  ...
                  <div class="table-responsive">
                    <table id="table_id2" class="table table-bordered table-sm table-hover"   cellspacing="0" style="width:100%;   font-size:13px;">
                       <thead><tr><th></th>   
                                  ...
                                  <th>Área de labores</th></tr></thead><tbody>
                            <?php 
                            ...
                            $query_familiares= mysqli_query($conn, "SELECT identidad , cod_empleado, nombre_completo, fecha_ingreso  FROM rr_hh_empleados WHERE status_empleado=1 ORDER BY nombre_completo ASC;");
                              ...
                              if (mysqli_num_rows($query_familiares)>0)
                              {
                                  ...
                                  while ($_row_familiares= mysqli_fetch_array($query_familiares)) 
                                  {
                                    ...
                                    $query_cons_area_labora ="SELECT  a.gerenciaid, b.descripcion  FROM organizacional_usuarios_gerencias a, organizacional_gerencias b WHERE a.gerenciaid=b.id and a.usuarioid ='$_cons_identidad_persona' and a.status=1  order by a.fecha_creacion desc limit 1  ;";
...
<?php 
 ...
 {  
    ...
    {        
        ...
        $query_txt_insert_new="INSERT INTO organizacional_usuarios_gerencias(usuarioid, gerenciaid ) VALUES('$_ins_identidad_persona', '$_ins_area_trabajo');";
