                                          ...
                                          echo "<td>".$cont."</td>
                                                <td>".$parenteco_tbl."</td>
                                                 ...
                                                 <td>
                                                    ...
                                                    <input type='number' step='.01' pattern='^\d*(\.\d{0,2})?$' name='arraybenef[]' style='width:80%' min='0' max='100' required value='".$porcentaje_seguro."' onblur='
 ...
 {  
    ...
    {            
        ...
        $query_txt_update= "UPDATE rr_hh_empleados_familias 
                            SET nombre_completo = '$_ins_nombre_completo' , parentesco = '$_ins_parentesco', sexo = '$_ins_sexo', domicilio = '$_ins_domicilio' ,  ocupaciondesc = '$_ins_ocupaciondesc', celular = '$_ins_celular' 
