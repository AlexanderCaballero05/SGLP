    ...
    <div class="card-body">
            ...
            <div class="col">
                <div class="input-group">
                    ...
                    <select name="nombre" id="nombre" onchange="seleccion_nombre()" class="form-control">
                        ...
                        $consulta_empleados = oci_parse($conn2, "SELECT * FROM PL_EMPLEADOS ORDER BY NOMBRE_PILA ");
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text" style="min-width:210px" readonly>OCUPACION: </div>
                    </div>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text" style="min-width:210px" readonly>SOLVENCIA DISTRITAL: </div>
                    </div>
                    <input type="text" name="solvencia_distrital" id="solvencia_distrital" class="form-control">
                </div>

                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text" style="min-width:210px" readonly>AFIL. SEGURO SOCIAL: </div>
                    </div>
                    <input type="text" name="afiliado_ss" id="afiliado_ss" class="form-control">
                </div>
            ...
            <div class="col">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text" style="min-width:220px" readonly>IMP. SOBRE LA RENTA: </div>
                    </div>
                    <input type="number" name="imp_s_r" id="imp_s_r" class="form-control">
                </div>

                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text" style="min-width:220px" readonly>REGISTRO TRIBUTARIO: </div>
                    </div>
                    <input type="text" name="registro_tributario" id="registro_tributario" class="form-control">
                </div>

                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text" style="min-width:220px" readonly>NACIONALIDAD: </div>
                    </div>
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text" style="min-width:220px" readonly>ESTADO CIVIL: </div>
                    </div>
