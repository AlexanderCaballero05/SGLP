...
WHERE date(a.checktime) BETWEEN '$fechai_asistencia' AND '$fechaf_asistencia' a.userid='$usuario_asistencia';");
...
$hora_marca           = $obj_datos_asistencia->hora_marca;
$fecha_marca          = $obj_datos_asistencia->fecha_marca;
...
$fecha_asistencia = date("d-m-Y", strtotime($fecha_asistencia));
?>
...
<section>
  ...
  <p>
    ...
    Por medio del presente solicito se me permita gozar de un día Compensatorio , el día  &nbsp;<strong><?php echo $_fecha_inicial; ?> </strong> &nbsp;, por haber asistido a trabajar el día  &nbsp;<strong><?php echo $fecha_asistencia; ?></strong>&nbsp;  EN ACTIVIDADES DE &nbsp;  <strong><?php echo $reason ?>   </strong>&nbsp;,  en una jornada de  &nbsp;<strong><?php echo $hora_entrada ; ?></strong>&nbsp; a   &nbsp; <strong><?php echo $hora_salida ; ?></strong>&nbsp; ACUMULANDO  &nbsp;<strong><?php echo $tiempo_trabajado; ?> </strong>HORAS LABORADAS.
  </p><br>
  <p>Nota :
    <?php  echo $_nota; ?>
  </p><br>
 ...
 <table width="100%">
  ...
  <tr>
    <td></td>
    <td align="center">GERENTE/JEFE <?php echo $area; ?></td>    
    <td></td>
  </tr>  
 </table>
</section>   
...
<div align="center">
<p>
     <br><button type="button" id="no_print" class="btn btn-success" onclick="window.print()"> Imprimir Solicitud </button>
</p>  
</div>
