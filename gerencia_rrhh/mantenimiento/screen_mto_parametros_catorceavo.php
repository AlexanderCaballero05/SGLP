...
if (isset($_POST['guardar_nuevo'])) {
	...
	if (mysqli_query($conn, "INSERT INTO rr_hh_mto_catorceavo (de_dia, de_mes, de_year, a_dia, a_mes, a_year, valor_porcentual_sueldo, tipo_contratacion) VALUES ('$de_dia','$de_mes','$de_year','$a_dia','$a_mes','$a_year','$porcentaje_vacaciones','$id_tipo_contrato') ") === TRUE) {
		echo "<div class = 'alert alert-info'>Parametro de catorceavo registrado correctamente.</div>";
	} else {
...
<br>
<h3  align="center" style="color:black;" ><b>MANTENIMIENTO DE PARAMETROS DE CATORCEAVO</b></h3>
<br>
</section>
<br>
...
while ($reg_tipo_contrataciones = mysqli_fetch_array($c_tipo_contrataciones)) {
	...
	$c_parametros_en_contrato = mysqli_query($conn, "SELECT * FROM rr_hh_mto_catorceavo WHERE estado = 'A' AND tipo_contratacion = '$id_tipo_contratacion' ");
