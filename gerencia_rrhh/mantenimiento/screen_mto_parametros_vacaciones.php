...
<ul class="nav nav-tabs">
 <li class="nav-item">
    <a style="background-color:#ededed;" class="nav-link active" href="#">Parametros Vigentes</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="./mto_parametros_vacaciones_otros_periodos.php" >Parametros de Otros Periodos</a>
  </li>
</ul>
...
<br>
<h3  align="center" style="color:black;" ><b>MANTENIMIENTO DE PARAMETROS DE VACACIONES VIGENTES</b></h3>
<br>
</section>
<br>
...
while ($reg_tipo_contrataciones = mysqli_fetch_array($c_tipo_contrataciones)) {
	...
	$c_parametros_en_contrato = mysqli_query($conn, "SELECT * FROM rr_hh_mto_vacaciones WHERE estado = 'A' AND tipo_contratacion = '$id_tipo_contratacion' AND periodo_final_vigencia IS NULL ORDER BY de_year ASC ");
