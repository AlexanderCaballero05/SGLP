...
$("#titulo").text('INFORME DE SECCIONALES BANCO DISTRIBUIDOR SIN ASIGNACION SORTEO # '+id_sorteo+' | '+res[1]);

token = Math.random();
consulta = 'informe_seccionales_sin_asignacion_banco_db.php?ss='+id_sorteo+"&token="+token;			
...
<br>
<h2  align="center" style="color:black; "  id="titulo" >INFORME DE SECCIONALES BANCO DISTRIBUIDOR SIN ASIGNACION</h2> 
