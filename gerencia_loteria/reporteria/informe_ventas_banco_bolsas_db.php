...
$result_wbs = $cliente-> call("ws_ventas", array("sorteo_envio" => $sorteo));
...
<table id="table_format" class="table table-bordered" width="100%">
	<thead>
		<tr>
			...
			<th>Bolsas Asignadas</th>
			<th>Bolsas Vendidas</th>
			<th>Bolsas No Vendidas</th>
			<th>Ultima Venta</th>
		</tr>
	</thead>
...
echo "<td>".$v_fields[4]."</td>";
echo "<td>".$v_fields[5]."</td>";
echo "</tr>";

$tt_asignado   += $v_fields[2];
$tt_vendido    += $v_fields[3];
$tt_no_vendido += $v_fields[4];
...
?>
		...
		<tr>
			...
			<th><?php echo $tt_asignado;   ?></th>
			<th><?php echo $tt_vendido;    ?></th>
			<th><?php echo $tt_no_vendido; ?></th>
			<th></th>
		</tr>
</table>
</div>
