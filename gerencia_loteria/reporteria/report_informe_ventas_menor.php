...
$sorteos = mysqli_query($conn, "SELECT a.id_sorteo as id , b.fecha_sorteo FROM empresas_estado_venta as a INNER JOIN sorteos_menores as b ON a.id_sorteo = b.id WHERE a.estado_venta != 'D' AND a.cod_producto != 1  AND a.id_sorteo >= '3175' GROUP BY a.id_sorteo ORDER BY a.id_sorteo DESC");
?>
...
$("#titulo").text('INFORME DE VENTAS MENOR SORTEO # '+id_sorteo+' | '+res[1]);
token = Math.random();
consulta = 'informe_ventas_menor_db.php?id_s='+id_sorteo+"&filtro="+filtro+"&token="+token;			
...
<br>
<h2  align="center" style="color:black; " id="titulo"  >INFORME DE VENTAS LOTERIA MENOR</h2> 
...
<div class="card card-body" id="non-printable" style="width: 100%; text-align:center">
<div class="input-group " style="margin:0px 0px 0px 0px; width: 100%" align = 'center'>
...
new Chart(document.getElementById("myChart"), {
    ...
    options: {
      ...
      title: {
        display: true,
        text: 'PORCENTAJES DE VENTA DE LOTERIA MENOR EN BASE A ASIGNACION'
      }
    }
});
