...
<h3 align="center"><b> ADMINISTRACION DE ESTADO DE VENTA DE SORTEOS DE LOTERIA MAYOR </b></h3>
<hr>
...
$info_sorteo_mayor = mysql_query("SELECT a.id, a.no_sorteo_may, a.fecha_sorteo, a.estado_venta, b.estado_venta as estado  FROM sorteos_mayores as a INNER JOIN empresas_estado_venta as b ON a.id = b.id_sorteo WHERE a.id = '$sorteo'  AND b.cod_producto = '1' limit 1");

if (mysql_num_rows($info_sorteo_mayor) > 0 ) {
$value2 = mysql_fetch_object($info_sorteo_mayor);
