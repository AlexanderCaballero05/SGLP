...
$departamentos = mysqli_query($conn, " SELECT DISTINCT(departamento) as departamento FROM distribucion_mayor_banco WHERE departamento != '' ORDER BY departamento ASC ");
...
$c_sorteos = mysqli_query($conn, "SELECT id, fecha_sorteo FROM sorteos_mayores  ORDER BY id DESC");
...
$agencias = mysqli_query($conn, "SELECT *  FROM distribucion_mayor_banco GROUP BY id_seccional  ORDER BY departamento, municipio ASC  ");
...
<div class=" input-group-append">
					...
					if (isset($_POST['seleccionar'])) {
						...
						$conulta_sorteo = mysqli_query($conn, "SELECT * FROM sorteos_mayores WHERE id = '$id_sorteo'  ");
						...
						if ($mes != "" and $departamento == "") {
							...
							$consulta_agencias = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, SUM(a.cantidad) as cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a LEFT JOIN  distribucion_mayor_banco as b ON a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE  a.estado_venta = 'APROBADO' AND cod_producto = '1' AND DATE(fecha_venta) BETWEEN '$fecha_1' AND  '$fecha_2'  AND b.departamento = '" . $departamento . "' GROUP BY a.id_seccional  ");
						} else if ($id_agencia == "todas") {

							$consulta_agencias = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, SUM(a.cantidad) as cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a INNER JOIN  distribucion_mayor_banco as b ON a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE a.id_sorteo = '" . $id_sorteo . "' AND a.estado_venta = 'APROBADO' AND cod_producto = '1' AND b.id_sorteo = '" . $id_sorteo . "' GROUP BY a.id_seccional  ");
						} else {
							...
							$consulta_agencias = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, SUM(a.cantidad) as cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a LEFT JOIN  distribucion_mayor_banco as b ON a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE a.id_sorteo = '" . $id_sorteo . "' AND a.estado_venta = 'APROBADO' AND cod_producto = '1' AND a.id_seccional = '" . $id_agencia . "' AND b.id_sorteo = '" . $id_sorteo . "' GROUP BY a.id_seccional  ");
						}
							...
							<div class="card-body">
								...
								while ($reg_consulta_agencias = mysqli_fetch_array($consulta_agencias)) {
									...
									if ($mes != "" and $departamento == "") {		
										...
										$consulta_agencias_v = mysqli_query($conn, "SELECT SUM(cantidad) as cantidad FROM transaccional_ventas_general as a  WHERE  a.estado_venta = 'APROBADO' AND cod_producto = '1' AND  DATE(fecha_venta) BETWEEN '$fecha_1' AND  '$fecha_2' AND a.id_seccional = '$id_seccional_consulta'  ");
										...
										$consulta_agencias_v = mysqli_query($conn, "SELECT SUM(cantidad) as cantidad FROM transaccional_ventas_general as a  WHERE  a.estado_venta = 'APROBADO' AND cod_producto = '1' AND a.id_seccional = '$id_seccional_consulta' AND  a.id_sorteo = '" . $id_sorteo . "' ");
										$ob_venta = mysqli_fetch_object($consulta_agencias_v);
										$vendido = $ob_venta->cantidad;
													...
													<table class="table table-bordered" id="">
														...
														<tbody>
															...
															if ($mes != "" and $departamento == "") {
																...
																$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a LEFT JOIN  distribucion_mayor_banco as b ON a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE  a.estado_venta = 'APROBADO' AND cod_producto = '1' AND DATE(fecha_venta) BETWEEN '$fecha_1' AND  '$fecha_2'  AND b.departamento = '" . $departamento . "' AND a.id_seccional = '$id_seccional_consulta' GROUP BY a.cod_factura_recaudador  ");
															} else if ($id_agencia == "todas") {

																$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a INNER JOIN  distribucion_mayor_banco as b ON a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE a.id_sorteo = '" . $id_sorteo . "' AND a.estado_venta = 'APROBADO' AND cod_producto = '1' AND b.id_sorteo = '" . $id_sorteo . "' AND a.id_seccional = '$id_seccional_consulta' GROUP BY a.cod_factura_recaudador  ");
															} else {
																...
																$id_agencia = $v_seccional[0];
																$nombre_agencia = $v_seccional[1];
																$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a LEFT JOIN  distribucion_mayor_banco as b ON a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE a.id_sorteo = '" . $id_sorteo . "' AND a.estado_venta = 'APROBADO' AND cod_producto = '1' AND a.id_seccional = '" . $id_agencia . "' AND b.id_sorteo = '" . $id_sorteo . "' AND a.id_seccional = '$id_seccional_consulta' GROUP BY a.cod_factura_recaudador  ");
															}
															...
															?>
																...
																<tr>
																	...
																	?>
																		<td><?php echo $v_vendedores[$reg_ventas['identidad_comprador']]['asociacion']; ?></td>
																	<?php
																	} else {
																	?>
																		<td></td>
...
if (isset($_POST['generar_excel'])) {
	...
	while ($reg_vendedores = mysqli_fetch_array($c_vendedores)) {
		$v_vendedores[$reg_vendedores['identidad']] = $reg_vendedores;
	}
	...
	if ($mes != "" and $departamento == "") {
		...
		$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a INNER JOIN  distribucion_mayor_banco as b INNER JOIN vendedores as c ON  a.identidad_comprador = c.identidad AND a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE  a.estado_venta = 'APROBADO' AND cod_producto = '1' AND DATE(fecha_venta) BETWEEN '$fecha_1' AND  '$fecha_2' GROUP BY a.cod_factura_recaudador  ");
	} else if ($mes != "" and $departamento != "") {
		...
		$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a LEFT JOIN  distribucion_mayor_banco as b INNER JOIN vendedores as c ON  a.identidad_comprador = c.identidad AND a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE  a.estado_venta = 'APROBADO' AND cod_producto = '1' AND DATE(fecha_venta) BETWEEN '$fecha_1' AND  '$fecha_2'  AND b.departamento = '" . $departamento . "' GROUP BY a.cod_factura_recaudador  ");
	} else if ($_POST['seccional_oculto'] == "todas") {

		$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a LEFT JOIN  distribucion_mayor_banco as b INNER JOIN vendedores as c ON  a.identidad_comprador = c.identidad AND a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE a.id_sorteo = '" . $id_sorteo . "' AND a.estado_venta = 'APROBADO' AND cod_producto = '1' AND b.id_sorteo = '" . $id_sorteo . "' GROUP BY a.cod_factura_recaudador ");
	} else {
		...
		$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a LEFT JOIN  distribucion_mayor_banco as b INNER JOIN vendedores as c ON  a.identidad_comprador = c.identidad AND a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE a.id_sorteo = '" . $id_sorteo . "' AND a.estado_venta = 'APROBADO' AND cod_producto = '1' AND a.id_seccional = '" . $id_agencia . "' AND b.id_sorteo = '" . $id_sorteo . "' GROUP BY a.cod_factura_recaudador ");
	}
	...
	while ($reg_ventas = mysqli_fetch_array($consulta_ventas)) {
		...
		if (isset($v_vendedores[$reg_ventas['identidad_comprador']])) {
			$objPHPExcel->getActiveSheet()->SetCellValue('H' . $row, $v_vendedores[$reg_ventas['identidad_comprador']]["asociacion"]);
		} else {
...
if (isset($_POST['generar_excel_especifico'])) {
	...
	if ($mes != "" and $departamento == "") {
		...
		$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a INNER JOIN  distribucion_mayor_banco as b INNER JOIN vendedores as c ON  a.identidad_comprador = c.identidad AND a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE  a.estado_venta = 'APROBADO' AND cod_producto = '1' AND DATE(fecha_venta) BETWEEN '$fecha_1' AND  '$fecha_2' AND a.id_seccional = '$id_seccional' GROUP BY a.cod_factura_recaudador  ");
	} else if ($mes != "" and $departamento != "") {
		...
		$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a LEFT JOIN  distribucion_mayor_banco as b INNER JOIN vendedores as c ON  a.identidad_comprador = c.identidad AND a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE  a.estado_venta = 'APROBADO' AND cod_producto = '1' AND DATE(fecha_venta) BETWEEN '$fecha_1' AND  '$fecha_2'  AND b.departamento = '" . $departamento . "' AND a.id_seccional = '$id_seccional' GROUP BY a.cod_factura_recaudador  ");
	} else if ($_POST['seccional_oculto'] == "todas") {

		$consulta_ventas = mysqli_query($conn, "SELECT a.cod_factura_recaudador, a.id_sorteo, a.id_entidad, a.cantidad, a.id_seccional, a.identidad_comprador, a.nombre_comprador , a.asociacion_comprador , a.fecha_venta, b.nombre_seccional, b.departamento, b.municipio FROM transaccional_ventas_general as a LEFT JOIN  distribucion_mayor_banco as b INNER JOIN vendedores as c ON  a.identidad_comprador = c.identidad AND a.id_seccional = b.id_seccional AND a.id_sorteo = b.id_sorteo WHERE a.id_sorteo = '" . $id_sorteo . "' AND a.estado_venta = 'APROBADO' AND cod_producto = '1' AND b.id_sorteo = '" . $id_sorteo . "' AND a.id_seccional = '$id_seccional' GROUP BY a.cod_factura_recaudador ");
	} else {
