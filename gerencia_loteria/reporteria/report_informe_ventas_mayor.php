...
$sorteos = mysqli_query($conn,"SELECT a.id_sorteo as id , b.fecha_sorteo FROM empresas_estado_venta as a INNER JOIN sorteos_mayores as b ON a.id_sorteo = b.id WHERE a.estado_venta != 'D' AND a.cod_producto = 1 AND a.id_sorteo >= '1202'  GROUP BY a.id_sorteo ORDER BY a.id_sorteo DESC");
?>
