...
<ul class="nav nav-tabs">
 <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" href="./facturacion_menor.php" >Lotería Menor</a>
  </li>
</ul>
...
<?php
$facturaciones = mysqli_query($conn," SELECT * FROM facturacion_mayor WHERE id_sorteo = '$id_sorteo' AND estado = 'A' ");
