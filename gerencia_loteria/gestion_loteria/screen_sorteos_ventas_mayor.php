...
consulta = 'sorteos_ventas_mayor_db.php?id_s='+sorteo+"&n_e="+nuevo_estado;			
...
<ul class="nav nav-tabs">
 <li class="nav-item">
  ...
  <li class="nav-item">
    <a  class="nav-link" href="./sorteos_ventas_menor.php">Lotería Menor</a>
  </li>
</ul>

<section style="background-color:#ededed;">
<br>
<h3 align="center"><b> ADMINISTRACION DE ESTADO DE SORTEOS DE LOTERIA MAYOR </b></h3>
<br>
</section>
...
<input type="submit" id="seleccionar" name="seleccionar" class="btn btn-primary" value="Seleccionar">
</div>
...
$info_sorteo_mayor = mysqli_query($conn,"SELECT a.id, a.no_sorteo_may, a.fecha_sorteo, a.estado_venta, b.estado_venta as estado  FROM sorteos_mayores as a INNER JOIN empresas_estado_venta as b ON a.id = b.id_sorteo WHERE a.id = '$sorteo'  AND b.cod_producto = '1' limit 1");

if (mysqli_num_rows($info_sorteo_mayor) > 0 ) {
$value2 = mysqli_fetch_object($info_sorteo_mayor);
$id_sorteo_mayor = $value2->id;
$num_sorteo = $value2->no_sorteo_may;
