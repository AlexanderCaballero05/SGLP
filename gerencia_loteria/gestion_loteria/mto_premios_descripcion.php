...
$premios = mysql_query("SELECT * FROM premios_mayores");
$ultimo_premio = mysql_query("SELECT MAX(id) as maximo FROM premios_mayores");
...
Mantenimiento de Descripciones de Premios de Loteria Mayor
</div>
...
if (mysql_query(" DELETE FROM premios_mayores WHERE id = '$id' ") === TRUE ) {
...
if (mysql_query("UPDATE premios_mayores SET descripcion_premios = '$desc'  WHERE id = '$id' ") ===false) {
echo mysql_error();
}
...
if (mysql_query("INSERT INTO premios_mayores (descripcion_premios) VALUES ('$nueva_desc') ") === true) {
