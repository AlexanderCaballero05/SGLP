...
if (isset($v_leido[0])) {
	if (in_array($billete_inicial_validacion, $v_leido)) {
...
$v_leido[$h] = $billete_inicial_validacion;
$h++;
...
echo "<button type = 'submit' value = '".$dataString."' class = 'btn btn-primary' id = 'guardar_importacion' name = 'guardar_importacion'>
GUARDAR
</button>
