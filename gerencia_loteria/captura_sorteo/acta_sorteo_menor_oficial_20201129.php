...
////////////////////////////////////////////////////////////////////
               ...
               /* $agencia_banrural='DISTRIBUIDO POR AGENCIA PANI';
                $monto_premio=money_format('%n',$monto[$cont2]);
                $monto_pagar=money_format('%n',0);*/
...
//$monto_pagar=money_format('%n', 0);
 ...
 /* if ($numero_ganador[$cont2] == 3877) {
   $monto_premio = 50000;
    $monto_pagar= 0;
  }

 if ($numero_ganador[$cont2] == 1976) {
  $monto_premio = 30000;
 $monto_pagar= 0;
  }

if($numero_ganador[$cont2] == 686){
$monto_premio=20000;
$monto_pagar=0;
}


if($numero_ganador[$cont2] == 1949){
$monto_premio=20000;
$monto_pagar=0;
}*/
