...
<div class="card-footer" align="center">
	<div class="row">
		...
		<div id="validacion" class="col-sm-4" align="left" >
		<?php
echo '<a href="./menor_acta_incentivos.php?s=' . $ultimo_sorteo . '" class="btn btn-danger" id="no_print" target="_blank">IMPRIMIR ACTA</a>';
?>
