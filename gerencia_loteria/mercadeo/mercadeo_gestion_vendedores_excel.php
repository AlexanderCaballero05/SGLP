<?php 
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('P1', 'FECHA DE CREACIÓN');
...
$row = 2;
$edad = "";
$ConVendedores = mysqli_query($conn, "SELECT a.identidad, a.nombre, a.asociacion, a.seccional,  a.codigo, a.numero_bolsas, a.estado_civil, a.sexo, a.telefono, b.dpto, b.municipio, a.direccion, a.zona_venta, a.estado, fecha_creacion FROM vendedores as a INNER JOIN geocodigos as b ON a.geocodigo = b.cod_muni  ");
...
$objPHPExcel->getActiveSheet()->SetCellValue('P' . $row, $reg_vendedores['fecha_creacion']);
