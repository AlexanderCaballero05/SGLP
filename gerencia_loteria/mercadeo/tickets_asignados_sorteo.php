...
$c_ticket_participantes = mysqli_query($conn, "SELECT * FROM sorteos_menores_otros_incentivos_tickets WHERE id_sorteo = '$id_sorteo'  ");
...
<?php
	...
	while ($reg_tickets = mysqli_fetch_array($c_ticket_participantes)) {
		...
		echo "<td>" . $reg_tickets["identidad"] . "</td>";
		echo "<td>" . $reg_tickets["nombre_completo"] . "</td>";
		echo "<td>" . $reg_tickets["sorteos_activos"] . "</td>";
