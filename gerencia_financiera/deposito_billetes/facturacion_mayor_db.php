...
if (isset($_POST['generar_ftp'])) {
	...
	$inventario = mysqli_query($conn, "SELECT b.num_mezcla,b.rango FROM sorteos_mezclas as a INNER JOIN sorteos_mezclas_rangos as b ON a.id_sorteo = b.id_sorteo AND a.num_mezcla = b.num_mezcla WHERE a.id_sorteo = '$id_sorteo' AND a.id_empresa = '$id_empresa'  ");
