...
$cc_factura = $ob_factura->no_factura;
...
$inventario_asignado = mysqli_query($conn, "SELECT COUNT(id_empresa) as conteo FROM sorteos_mezclas as a  WHERE a.id_sorteo = '$id_sorteo' AND  a.id_empresa = '$id_empresa' AND cod_factura = '$cc_factura'  ");
...
<table width="100%">
	...
	<td colspan="2" align="center" >Daniel Fúnez</td>
	</tr>
