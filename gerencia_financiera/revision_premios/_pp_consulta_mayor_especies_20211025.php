    ...
    if ($query === false) {  echo mysqli_error();  }
      ...
      $desc_premio='';
        ...
        if ($estado_especies==1) 
        {
         ...
         echo "<div class='card'>
         <div class='card-header bg-success text-white' >El billete número <strong>".$numero."</strong> del sorteo <strong>".$sorteo."</strong> con décimo número  <strong>".$decimo_premiado."</strong>  es el ganador de un premio en especies </div>
