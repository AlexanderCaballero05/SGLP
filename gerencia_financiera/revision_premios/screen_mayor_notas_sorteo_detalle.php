...
<div id='div_wait'></div>
<section style="text-align: center; background-color:#ededed; padding-top: 10px;"><h3>Ajustes de Lotería Mayor del Sorteo # <?php echo $sorteo; ?>  </h3><br></section>
...
<tbody>
<?php 
 $query= mysqli_query($conn, "SELECT id, transactiondate, remesa, transactionagencyname, transactionusername, comentario_revisor comentario, tipo_documento, incidencia, fecha_creacion, sorteo, numero, decimos_nota decimos, registro, neto_nota total, impto, neto_nota neto FROM `rp_notas_credito_debito_mayor` where sorteo=$sorteo");
