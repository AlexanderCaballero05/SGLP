...
$_remesa=$_GET['remesa'];  $_agency=$_GET['agencia'];   $_fecha_pago=$_GET['fecha_pago'];   $_action=$_GET['acc']; $_ano_remesa=$_GET['ano_remesa'];
  ...
  if ($_action==1)   
  { 
    $requete = mysqli_query($conn, "UPDATE menor_pagos_detalle a, menor_pagos_recibos b set remesa=$_remesa, ano_remesa=$_ano_remesa,   fecha_recepcion_banco=CURRENT_TIMESTAMP  where a.transactioncode=b.transactioncode and date(a.transactiondate) = '$_fecha_pago'  and b.transactionagency='$_agency' and a.transactionstate in (1,3) ");  
  ...
  { 
    $requete = mysqli_query($conn, "UPDATE menor_pagos_detalle a, menor_pagos_recibos b set remesa=0   , ano_remesa=null,  fecha_recepcion_banco=null   where a.transactioncode=b.transactioncode and date(a.transactiondate) = '$_fecha_pago'  and b.transactionagency=$_agency and a.transactionstate in(1,3) ");  
  ...
  {   
              ...
              echo "<div class='row' style='padding-bottom: 0px;'><div class='col-md-1' align='center'></div>       
                    <div class='col-md-10' align='center'><legend><div class='alert alert-success'><label>Información Seleccionada para la Remesa No. ".$_remesa." del año ".$_ano_remesa."  </label></div></legend> 
                    <div class='table-responsive' style='padding-bottom: 0px; page-break-after: always'>
                                ...
                                if ($result_remesados)
                                  {
                                    ...
                                    {  
                                      ...
                                      echo "<tr><td  align='left'>".$row_remesados['seccional']."</td>
                                                ...
                                                <button type='button' id='option1".$contador_remesados."'  id='option1".$contador_remesados."' onclick='add_remesa(this.value, 2)'  value='".$_remesa."--".$row_remesados['transactionagency']."--".$row_remesados['seccional']."--".$_fecha_pago."--".$_ano_remesa."' class='btn btn-sm btn-success'><i class='far fa-thumbs-up fa-lg'></i>   Quitar de la Remesa</button>
                                                </td></tr></tbody>";
                                                $contador_remesados ++;    
                                     }                                      
