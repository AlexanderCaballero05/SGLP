...
$_remesa=$_GET['remesa']; $_revisor=$_GET['revisor'];  $ano_remesa=$_GET['ano_remesa']; 
      ...
      $_revisor_name = $ob_nombre->nombre_completo;
       ...
       echo'<div class="font-style" style="text-align:center; font-size: 19;" id="Imprime">
                       ...
                       Liquidacion de Remesa No. '.$_remesa.' del año '.$ano_remesa.' de Loteria Menor <br> Revisor '.$_revisor_name.'
            </div><br><br>';

      $query_sorteos=mysqli_query($conn, "SELECT  sorteo FROM menor_pagos_detalle  where estado_revision=1 and remesa=$_remesa and ano_remesa='".$ano_remesa."' and usuario_revision=$_revisor  group by  sorteo;");
