...
<section style="text-align: center;  padding-top: 10px;"><h5>Patronato Nacional de la Infancia  <br> Departamento de Revision de Premios <br> Liquidación de Sorteo <?php echo $sorteo; ?> de Loteria Mayor </h5> </section><br><br>
 <?php    
    ...
    $_cantidad_entregada_total = 0;    $_monto_entregado_total    = 0;
        ...
        while ($row_numeros=mysqli_fetch_array($query_numeros)) 
        {
                  ...
                  {     
                     ...
                     $query_descripcion =  mysqli_query($conn, "SELECT desc_premio FROM sorteos_mayores_premios WHERE  sorteos_mayores_id=$sorteo and numero_premiado_mayor=$numero_termi ");
                     while ($row_pal=mysqli_fetch_array($query_descripcion) ) 
                     {
                         $pal_premio= $row_pal['desc_premio'];
                     }
                     //echo "string <br>".$pal_premio;
                     $palabra='Valor Monetario de '.$pal_premio.' del billete'; 
           ...
           echo "<tr><td colspan='2' align='center'><label>Total Revisado</label></td><td align='center'><label>".number_format($cantidad_acumulado)."</label></td><td align='right'><label>".number_format($neto_acumulado,2,'.',',')."</label></td><td></td></tr>";
          ...
          //  $query_info_revisado_notas=mysqli_query($conn, "SELECT decimos_nota decimo, neto_nota neto, tipo_documento FROM rp_notas_credito_debito_mayor WHERE sorteo=$sorteo;");
           ...
           {   /*
            ...
            {              
              ...
              {  
                 ...
                 $cantidad_notas_cc_2 =  $row_notas_aa['decimo'];  
                 $text_nota='Nota de Credito';
              }
              else
              { 
                $cantidad_notas_cc=$row_notas_aa['decimo'];     
                $monto_notas_cc=$row_notas_aa['neto'];  
              }
             
              echo "<tr class='table-danger'><td>".$cantidad_notas_cc."</td>
        ...
        echo "<tr><td></td>
              ...
              <tr class='table-success'><td></td>
                  <td colspan='1' align='center'><label> Liquidación Total del Sorteo</label></td>
...
<div align="center">
  ...
  <?php echo  "<br>".$_SESSION['nombre_usuario']; ?>
</div>
</section>
