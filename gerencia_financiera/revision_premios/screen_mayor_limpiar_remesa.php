...
function act_esta(valor, accion, contador, id)
{
         ...
         $(".div_wait").fadeIn("fast");
              ...
              var urr_revi_true = "./_rp_limpiar_revision_mayor.php?id=" + id+"&usu="+user+"&estado=1&agencia_code="+agencia_code+"&fecha_inicial="+fecha_inicial+"&valida="+Math.random();   
...
<section style="text-align: center; background-color:#ededed; padding-top: 10px;"><h3>Limpiar Billetes posteados de Lotería Mayor</h3> <br></section>
<section>
                    ...
                    if (isset($_POST['buttonConsulta']))
                      {  
                            ...
                            {                       
                              ...
                              $_result_sorteo=mysqli_query($conn, "SELECT sorteo FROM mayor_pagos_detalle a, mayor_pagos_recibos b  WHERE a.transactioncode=b.transactioncode and date(a.transactiondate) ='$_fecha_inicial' and b.transactionagency=$_agencia  group by sorteo order by sorteo asc")  ;                                                                                          
                             ...
                             {                             
                                ...
                                $result = mysqli_query($conn, "SELECT a.id, a.transactiondate, a.sorteo, a.numero, a.decimos, a.registro, a.totalpayment, a.imptopayment, a.netopayment neto, b.transactionagencyname seccional, a.transactionstate ,  estado_revision
                                                    ...
                                                    order by transactionuser, numero asc;");
