    ...
    if (acc==1) 
      {
            ...
            .then(() => {  
             ...
             var urr_update_serie = '_pp_add_remesa_mayor.php?remesa='+remesa+'&agencia='+agencia+'&usuario='+user+'&acc='+ acc + '&fecha_pago='+ fecha_up +'&al='+Math.random();              
      ...
      $_fecha_pago=$_POST['fecha_inicial'];  $_remesa=$_POST['remesa']; 
            echo  "<div class='row' >                             
                        <div class='col-md-1' align='center'></div>
                          <div class='col-md-10' align='center'><legend><div class='alert alert-info'>Información de Billetes Pagados en fecha ".$_fecha_pago." con número de remesa No. ".$_remesa.".</div></legend>
                                ...
                                if (mysqli_num_rows($result_remesados)>0)
                                  {
                                    ...
                                    {  
                                      ...
                                      echo "<tr><td  align='left'>".$row_remesados['transactionagency']." -- ".$row_remesados['seccional']."</td>
                                                ...
                                                <td  align='center'  id='btn-rev'>  
                                                <button type='button' name='option1".$contador."' id='option1".$contador."' onclick='add_remesa(this.value, 2)'  value='".$_remesa."--".$row_remesados['transactionagency']."--".$row_remesados['seccional']."--".$_fecha_pago."' class='btn btn-sm btn-danger'><i class='far fa-thumbs-down fa-lg'></i>  Quitar a la Remesa</button>       
                                                </td></tr></tbody>";
                                                $contador_remesados ++;    
                                     }                                      
