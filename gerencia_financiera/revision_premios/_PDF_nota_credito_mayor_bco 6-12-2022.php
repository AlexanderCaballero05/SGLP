...
<?php      
  ...
  $cantidad_acumulado_final=0;  $neto_acumulado_final=0;
    ...
    $query_sorteos=mysqli_query($conn, "SELECT  sorteo FROM mayor_pagos_detalle   where estado_revision=1 and sorteo=$sorteo  group by  sorteo;");     if ($query_sorteos===false) {echo mysql_error(); }  
