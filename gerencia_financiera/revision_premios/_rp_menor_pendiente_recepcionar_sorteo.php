 ...
 <?php    
    $cantidad_acumulado_final=0;  $neto_acumulado_final=0;      
         ...
         echo  "<table width='96%'  id='tableinfo' align='center' class='table table-hover table-sm table-bordered'>         
          ...
          $query_numeros=mysqli_query($conn, "SELECT a.transactiondate, b.transactionagency,  b.transactionagencyname, b.transactionusername, a.sorteo, a.numero, a.serie, a.registro, a.principal, a.impto, a.neto
                                              FROM menor_pagos_detalle a , menor_pagos_recibos b
                                              WHERE   a.transactioncode=b.transactioncode and   
                                                      a.sorteo=$sorteo  and
                                                      a.transactionstate=1  and a.fecha_recepcion_banco is null ");
