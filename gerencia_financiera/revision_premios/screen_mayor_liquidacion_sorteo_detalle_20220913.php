 ...
 <?php    
    $cantidad_acumulado_final=0;  $neto_acumulado_final=0;      
        ...
        while ($row_numeros=mysqli_fetch_array($query_numeros)) 
        {
           ...
           $query_info_revisado_notas=mysqli_query($conn, "SELECT decimos_nota decimos, neto_nota neto, tipo_documento FROM rp_notas_credito_debito_mayor WHERE sorteo=$sorteo;");
