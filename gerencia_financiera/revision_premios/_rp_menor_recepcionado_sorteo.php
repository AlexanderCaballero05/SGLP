...
<div id='div_wait'></div>
<section style="text-align: center; background-color:#ededed; padding-top: 10px;"><h3>Detalle de Pagos Pendientes de Recibir de Lotería Menor de sorteo <?php echo $sorteo; ?>  </h3>   <br></section>
 <?php    
    $cantidad_acumulado_final=0;  $neto_acumulado_final=0;      
        
         echo  "<table width='96%'  align='center' class='table table-hover table-sm table-bordered' id='table_id1'>         
                <thead><th>No.</th>
                       <th>Fecha de Pago</th>
                       <th>Agencia</th>
                       <th>Cajero</th>
          ...
          $query_numeros=mysqli_query($conn, "SELECT a.transactiondate, a.remesa,  b.transactionagency,  b.transactionagencyname, b.transactionusername, a.sorteo, a.numero, a.serie, a.registro, a.principal, a.impto, a.neto
                                              FROM menor_pagos_detalle a , menor_pagos_recibos b
                                              WHERE   a.transactioncode=b.transactioncode and   
                                                      a.sorteo=$sorteo  and
                                                      a.transactionstate=1  and a.fecha_recepcion_banco is not null ");
