          ...
          function add_remesa(valor, acc )
          {
            ...
            if (acc==1) 
            {
                  ...
                  .then(() => {  
                   ...
                   var urr_update_serie = '_pp_add_remesa_menor.php?remesa='+remesa+'&ano_remesa='+ano_remesa+'&agencia='+agencia+'&usuario='+user+'&acc='+ acc + '&fecha_pago='+ fecha_up +'&al='+Math.random();              
            ...
            else
            {
                  swal({
                    title: "Esta Seguro?",
                    text: "Ud. Esta a punto de QUITAR a la remesa "+ remesa +" del año " +ano_remesa + " los pagos de la agencia " + agencia_txt + " !",
                    showCancelButton: true,
                    cancelButtonColor: '#d33',  
                    reverseButtons: true,
                    confirmButtonColor: '#28a745', 
