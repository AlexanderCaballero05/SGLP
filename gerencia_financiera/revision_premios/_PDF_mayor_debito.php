...
$contenido ="";
 $contenido .= '<table  class="table table-hover table-sm table-bordered" id="">
			    	    ...
			    	    $query_info_notas = mysqli_query($conn, "SELECT a.id, id_detalle, transactioncode, a.agencia, transactionagency, transactionagencyname, transactiondate, cajero, transactionusername , remesa, sorteo, numero, decimos_nota decimos, neto_nota neto,  incidencia,  tipo_documento, comentario_revisor, fecha_creacion, state estado, b.nombre_completo  FROM rp_notas_credito_debito_mayor a,  pani_usuarios b WHERE a.usuario=b.id and ano_remesa>'2018' and a.id=$id order by transactiondate asc;");
			    	    ...
			    	    if (mysqli_num_rows($query_info_notas)>0) 
			    	    {
			    	    	 ...
			    	    	 while( $row_info_notas=mysqli_fetch_array($query_info_notas))
			    	    	 {
			    	    	 	...
			    	    	 	$contenido .=  "<tr><td>".$fecha_pago."</td>
					    	    	 			    ...
					    	    	 			    <td>".$sorteo."</td>
					    	    	 			    <td>".$numero."</td>
					    	    	 			    <td align='right'>".number_format($decimos,2)."</td>
...
echo '<table align="center">
        ...
        <tr>
         ...
         <tr><td width="20%"></td>
           ...
           <br> Nota de Debito de Loteria Mayor No. '.$id.'  a favor del PANI
