			    	    ...
			    	    <?php		
								...
								$acumulado_billetes_pendientes    			= 0;        $acumulado_neto_pendiente       	   = 0;
			    	  			...
			    	  			while ($sorteo_inicial <= $sorteo_final) 
			    	  			{
									...
									$query_revisado_debitos=mysqli_query($conn, "SELECT sum(decimos) conteo_debitos, sum(neto) neto_debitos FROM rp_notas_credito_debito_mayor WHERE sorteo=$sorteo_inicial");
