...
<div id='div_wait'></div>
<section style="text-align: center; background-color:#ededed; padding-top: 10px;"><h3>Asignación de Lotería Menor por Fecha</h3> <br></section>
...
{  	
  ...
  echo "<div class='row'>
          <div class='col-sm-12' id='tabl'>
            <div class='alert alert-success' role='alert'><h3>Asignación de Loteria Menor Remesa ".$_remesa."</h3></div><hr>
