...
<h2 align="center" style="color:black;" >
  <b>VENTA DE LOTERIA MAYOR DETALLADA
...
echo "<div class = 'card' style = 'margin-left:5px;margin-right:5px;'>";
echo "<div class = 'card-header bg-primary text-white'><h4 align = 'center'>OTRAS ENTIDADES</h4></div>";
echo "<div class = 'card-body'>";
...
$v_descuento[$posicion]       = $v_descuento[$posicion]       + $reg_consulta_fvp['descuento'];
...
$v_descuento[$key]       = $reg_consulta_fvp['descuento'];
...
$v_descuento[0]       = $reg_consulta_fvp['descuento'];
...
$acumulado_descuento  += $reg_consulta_fvp['descuento'];
...
echo "<td>".number_format($reg_consulta_fvp['descuento'], 2)."</td>";
echo "<td>".number_format($reg_consulta_fvp['neto'], 2)."</td>";
echo "<td>".number_format($reg_consulta_fvp['comision_bancaria'], 2)."</td>";
...
echo "<div class = 'card' style = 'margin-left:5px;margin-right:5px;'>";
echo "<div class = 'card-header bg-primary text-white'><h4 align = 'center'>TOTAL VENTAS</h4></div>";
echo "<div class = 'card-body'>";
...
echo "<td>".number_format($v_neto[$i], 2)."</td>";
...
echo "<th>".number_format($total_neto, 2)."</th>";
echo "<th>".number_format($total_comision, 2)."</th>";
