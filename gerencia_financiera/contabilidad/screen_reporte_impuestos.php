...
<section id="no_print" style="text-align: center; background-color:#ededed; padding-top: 10px;"><h3>Reporte de Impuestos por pagos de Loteria</h3><br></section>
<section>
...
{ 
  ...
  $total_pagar_final=0;
  echo "<div align='center' class='alert alert-success' style='font-size:16pt;' ><strong> Patronato Nacional de la Infancia PANI <br> Departamento de Revisión de Premios <br> Reporte de Impuesto por pagos de Lotería Mayor y Menor <br>  ".$monthName." de ".$año_txt." </strong></div>";
...
a.transactionstate = 1");
 ...
 ?>
     ...
     if (mysqli_num_rows($query_impto_mayor)>0) {
         ...
         while ( $row_sorteo_mayor=mysqli_fetch_array($query_impto_mayor)) 
        {
           ...
           $neto                  = $row_sorteo_mayor['netopayment'];
                    ...
                    echo "<tr class='bg-info'> <td align='center'> ".$loteria."       </td>
    ...
    $total_pagar_final = $sumatoria_impto_mayor + $sumatoria_impto_menor;
