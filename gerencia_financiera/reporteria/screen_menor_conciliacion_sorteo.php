    	       	...
    	       	<div class="table-responsive">
    	       		<table  class="table table-hover table-sm table-bordered">
    	       			<thead><tr align="center">
		    	       				...
		    	       				<th id="no_print"></th>		    	       				 
		    	       				<th colspan="5">Pendiente || Caduco</th>	
		    	       				<th id="no_print"></th>	    	       				
		    	       			</tr> 
		    	       			<tr><th>Sorteo</th>
		    	       				<th>Fecha Sorteo</th>
								...
								$acumulado_impto_pendiente = 0;
			    	  			...
			    	  			while ($sorteo_inicial <= $sorteo_final) 
			    	  			{
									...
									$dias        			   = $info_sorteo->dias;
			    	  				...
			    	  				$query_compromiso=mysqli_query($conn, "SELECT COUNT(*) conteo, SUM(totalpayment) as bruto_compromiso, SUM(imptopayment) as impto_compromiso, sum(netopayment) neto_compromiso from archivo_pagos_menor where sorteo=$sorteo_inicial");
									...
									$query_pagado=mysqli_query($conn, "SELECT COUNT(*) conteo_pagado, sum(a.principal) bruto_pagado , sum(a.impto) impto_pagado , sum(neto) neto_pagado from menor_pagos_detalle a, menor_pagos_recibos b where a.transactioncode = b.transactioncode and sorteo=$sorteo_inicial and a.transactionstate in (1,3)");
			    	 			...
			    	 			echo "<tr class='table-success'><td colspan='4' align='center'> Totales</td>
     									  ...
     									  <td align='right'>" . number_format($acumulado_bruto_pendiente, 2) . "</td>
					    	       		  <td align='right'>" . number_format($acumulado_impto_pendiente, 2) . "</td>
