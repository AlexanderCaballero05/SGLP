...
token = Math.random();
consulta = 'consulta_pago_venta.php?f_i='+fecha_inicial+"&f_f="+fecha_final+"&filtro=2&token="+token;     
...
<div class="card text-center border-info" style="margin-right: 15px; margin-left: 15px"> 
  <div class="card-header text-white bg-info">
    ...
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
        <a class="nav-link " style="color: white" href="screen_pago_venta_mayor.php">Loteria Mayor</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active"  href="#">Loteria Menor</a>
      </li>
    </ul>
  </div>
  <div class="card-body">
