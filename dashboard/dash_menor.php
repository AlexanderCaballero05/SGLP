...
token = Math.random();
consulta = 'get_info_dash_menor.php?param='+parametros+"&token="+token;
...
<ul class="nav nav-tabs">
 <li class="nav-item">
    <a  class="nav-link" href="index.php" >Lotería Mayor</a>
  </li>
  <li class="nav-item">
...
<div class="col">
<div class="card" id="card_ventas"  align="left">
